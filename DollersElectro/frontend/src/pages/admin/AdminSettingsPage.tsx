    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage your admin account security</p>
              </div>
            </div>
      ...
      <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="backdrop-blur-2xl bg-white/80 rounded-2xl shadow-xl border-2 border-white/60 p-6">
            <div className="flex items-center space-x-3 mb-6">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-purple-500/90 to-purple-600/90 shadow-lg shadow-purple-500/50">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all bg-white/80"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all bg-white/80"
              ...
              <button
                ...
                className="w-full px-6 py-3 backdrop-blur-xl bg-gradient-to-br from-purple-500/90 to-purple-600/90 text-white rounded-2xl hover:from-purple-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl hover:scale-105 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="backdrop-blur-2xl bg-white/80 rounded-2xl shadow-xl border-2 border-white/60 p-6 lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Additional account security features</p>
              </div>
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Send a password reset link to your email: <strong>{user?.email}</strong>
                    </p>
                    <button
                      onClick={handleForgotPassword}
                      className="px-4 py-2 backdrop-blur-xl bg-gradient-to-br from-orange-500/90 to-orange-600/90 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all shadow-md hover:shadow-lg hover:scale-105 font-medium text-sm"
                    >
                      Send Reset Link
                    </button>
                  </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <p className="text-gray-600">
                        <span className="font-medium">Role:</span> <span className="text-blue-600 font-semibold">Administrator</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                After changing your password or email, you will be automatically logged out and need to login again with your new credentials. 

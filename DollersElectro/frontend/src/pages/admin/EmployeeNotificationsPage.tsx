...
const EmployeeNotificationsPage: React.FC = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-blue-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full text-center backdrop-blur-2xl bg-white/70 rounded-3xl shadow-2xl border-2 border-white/60 p-8">
          ...
          <p className="text-gray-500 mb-8">
            Please sign in as employee to view employee notifications.
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage your tasks and order notifications
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-300 ${
                  filter === filterOption.key
                    ? 'backdrop-blur-2xl bg-gradient-to-br from-green-500/90 to-blue-600/90 text-white shadow-lg'
        ...
        {isLoading && notifications.length === 0 ? (
          <div className="text-center py-20 backdrop-blur-2xl bg-white/70 rounded-3xl shadow-xl border-2 border-white/60">
            <ArrowPathIcon className="mx-auto h-24 w-24 text-green-500 mb-6 animate-spin" />
            ...
            {filteredNotifications.map((notification) => (
              <div
                ...
                className={`backdrop-blur-2xl bg-white/70 rounded-2xl shadow-lg border-l-4 ${getNotificationColor(notification.type, notification.priority)} ${
                  !notification.isRead ? 'ring-2 ring-green-500/30 shadow-green-500/20' : ''
